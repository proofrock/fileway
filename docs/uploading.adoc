...
Simply provide the secret, and either choose a file or input a secret text to share. And push "Upload".
...
If you want to share a secret text, use the `--txt` commandline arguments, with a text as the other argument.
